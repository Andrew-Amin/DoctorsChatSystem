...
class DownloadTask {
    ...
    DownloadTask(Context context, String downloadUrl , String fileName) {
            ...
            try {
                if (outputFile != null) {
                    ...
                    alertDialogBuilder.setNegativeButton("Open report",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            File pdfFile = new File(Environment.getExternalStorageDirectory() + "/DLA/" + downloadFileName);  // -> filename = maven.pdf
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/" + "DLA");
                } else
